<template>
    <div>
    <h1 class="title">טריוויה תחרותית</h1>
    <div class="subTitle">.חיווי מיידי, סופר שאלות שנענו נכון, הורדת חיים במידת הצורך, סדר שאלות רנדומלי</div>
    <br>
    <div class="subTitle">חיים: {{ lives }}</div>
    <br>
    </div>
